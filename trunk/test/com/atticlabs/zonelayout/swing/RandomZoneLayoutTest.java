...
//            boolean revokeFromZeroGiveWhenNecessary = random.nextInt(100) == 0;
...
//            System.out.println("sum original sizes: " + sum(originalSizes));
//            System.out.println("sum min sizes: " + sum(minSizes));
//            System.out.println("revokable space: " + totalRevokableSpace);
//            System.out.println("givable space: " + totalGivableSpace);
//            System.out.println("revokeFromZeroGiveWhenNecessary: " + revokeFromZeroGiveWhenNecessary);
//            System.out.println("space : " + space);

            layout.revokeAdditionalSpace(sections, space, new DisplaySizeView(), new MinimumSizeView()); //, revokeFromZeroGiveWhenNecessary);

            for (int i = 0; i < sections.size(); i++) {
                Section section = (Section) sections.get(i);
//                System.out.println(i + ": g" + section.getGive() +  " m" + section.getMinimumSize() + ", s" + section.getSize() + ", o" + originalSizes[i]);
            }

//            System.out.println("total size: " + totalSize(sections));

//            if (revokeFromZeroGiveWhenNecessary) {
//                if (totalRevokableSpace > space) {
//                    int neededFromZeroGive = (space > totalGivableSpace) ? space - totalGivableSpace : 0;
//                    int zeroGiveSectionCount = 0;
//
//                    for (int i = 0; i < sections.size(); i++) {
//                        Section section = (Section) sections.get(i);
//                        if (section.getGive() == 0) {
//                            zeroGiveSectionCount++;
//                        }
//                    }
//
//                    assertEquals(sum(originalSizes) - space, totalSize(sections));
...
//                        Section section = (Section) sections.get(i);
//                        if (section.getGive() == 0) {
//                            assertEquals(((double) originalSizes[i] - ((double) neededFromZeroGive / (double) zeroGiveSectionCount)), (double) section.getSize(), 1.0);
//                        }
//                        else if (section.getGive() * space / totalGive >= originalSizes[i] - minSizes[i]) {
//                            assertEquals(section.getSize(), section.getMinimumSize());
//                        }
//                        else {
//                            int maxSize = originalSizes[i] - (section.getGive() * space / totalGive);
//                            assertTrue(section.getSize() <= maxSize);
//                        }
//                    }
//                }
//                else {
////                    System.out.println("not enough, going to min");
//                    assertEquals(sum(originalSizes) - totalRevokableSpace, totalSize(sections));
//
//                    for (int i = 0; i < sections.size(); i++) {
//                        Section section = (Section) sections.get(i);
...
//                    System.out.println("not enough, using all givable space");
